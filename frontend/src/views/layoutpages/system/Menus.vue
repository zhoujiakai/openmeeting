    ...
    <div class="ve_container">
        ...
        >
            ...
            <el-table-column prop="sort" label="排序">
                <template v-slot="{ row }">
                    <span v-if="row.menuType !== 2" style="font-weight: bold">
                        {{ row.sort }}
                    </span>
                    <span v-else>/</span>
                </template>
            ...
            >
                <template v-slot="{ row }">
                    <template v-if="row.menuType == 1">
                        ...
                        <span v-else>{{ row.menuUrl }}</span>
                    </template>
                    <span v-else-if="row.type == 2">{{ row.buttonName }}</span>
                    <span v-else>/</span>
                </template>
            </el-table-column>
            <el-table-column fixed="right" label="操作" width="240">
                <template v-slot:default="{ row }">
                    ...
                    <el-button
                        v-permission="['addBtn']"
                        v-if="row.menuType == 1 && row.iframe == 0"
